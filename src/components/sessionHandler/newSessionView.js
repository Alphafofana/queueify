    ...
    <Container fluid className={css.sessionContainer}>
      <Col>
        <Jumbotron className={css.sessionJumbo}>
          ...
          <p>
            Thank you for using Queueify. You don't have an active session yet.
            Let's start one!
          </p>
          <Form onSubmit={submit}>
            <Form.Group controlID="sessionName">
              ...
              ></Form.Control>
			  <Form.Text>
                The name your guests will use to identify the session
              </Form.Text>
			  <Form.Group controlID="sessionPin">
              <Form.Label>Session Pin</Form.Label>
              <Form.Control type="password" placeholder="Pin" onChange={(event) => sessionPin(event.target.value)}></Form.Control>
			  <Form.Text>Type in a pin or passphrase</Form.Text>
			  </Form.Group>
